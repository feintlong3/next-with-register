...
import { type PersonalInfoSchema } from '@/lib/schema/register-schema'

interface Step1BasicFormProps {
...
/**
 * Step1 基本情報入力フォーム (Presentational)
 * - 氏名、メール、電話番号、住所の入力フィールド
 * - 送信ボタン
 */
export function Step1BasicForm({ form, isSaving, onSubmit }: Step1BasicFormProps) {
  return (
